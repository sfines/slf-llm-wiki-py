...
from src.agents.builder import create_writer_agent, create_evaluator_agent, create_editor_agent
...
class GenerationWorkflow:
    ...
    async def process_document(self, document_id: str, filename: str, body: str, max_revisions: int = 1) -> Optional[str]:
        """
