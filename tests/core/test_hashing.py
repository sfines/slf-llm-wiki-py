from src.core.hashing import generate_content_hash, generate_short_hash, normalize_content
...
class TestComputeContentHash:
    ...
    def test_different_content_produces_different_hash(self):
        hash1 = generate_content_hash("content one")
        hash2 = generate_content_hash("content two")
        assert hash1 != hash2
...
class TestGenerateShortHash:
    ...
    def test_is_prefix_of_full_hash(self):
        ...
        full = generate_content_hash(content)
